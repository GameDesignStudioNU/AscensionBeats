...
{
    public float ButtonPressLiveTime = .15f;
    private float AxisOverlap = 3.5f;
    ...
    public bool DashButtonPress { get
        {
            return Input.GetKeyDown(KeyCode.LeftControl) || Input.GetKeyDown(KeyCode.X) || Input.GetButtonDown("Dash") || Input.GetAxis("Dash2") > 0;
        } }
    public bool DashButtonHold { get
        {
            return Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.X) || Input.GetButton("Dash");
        } }
    public bool PauseButtonPress { get
        {
            return Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Start");
        } }
